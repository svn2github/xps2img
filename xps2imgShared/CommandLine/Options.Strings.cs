...
namespace Xps2Img.Shared.CommandLine
{
    public partial class Options
    {
        ...
        public  const string PagesDisplayName = "Page Number(s)";
        ...
        public  const string JpegQualityDisplayName  = "JPEG Quality";
        ...
        public  const string TiffCompressionDisplayName  = "TIFF Compression";
        ...
        public  const string RequiredSizeDisplayName = "Image Size";
        private const char   RequiredSizeOption      = 'r';

        private const string DpiDescription  = "Image DPI (16-2350)\n  DPI will be ignored if image size is specified";
        public  const string DpiDisplayName  = "Image DPI";
        ...
        public  const string ImageNameDisplayName = "Image Prefix";
        ...
        public  const string FirstPageIndexDisplayName  = "First Page Index";
        ...
        public  const string PrelimsPrefixDisplayName  = "Preliminaries Prefix";
        ...
        public  const string ProcessorsDisplayName       = "Processors";
        ...
        public  const string CpuAffinityDisplayName       = "Processors Affinity";
        ...
        public  const string ProcessPriorityDisplayName       = "Processors Priority";
