...
Klaus Prückl
klaus.prueckl@aon.at
http://workspaces.gotdotnet.com/getopt
...
Gnu.Getopt.ndoc      NDoc project file (for C# XML documentation [3])
Gnu.Getopt.nunit     NUnit project file (for automated tests [4])
