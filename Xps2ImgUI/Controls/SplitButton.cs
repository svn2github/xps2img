...
namespace wyDay.Controls
{
    public class SplitButton : Button
    {
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            var focusRect =
                new Rectangle(internalBorder - 1,
                              internalBorder - 1,
                              bounds.Width - /*dropDownRectangle.Width -*/ internalBorder - 2,
        ...
        private void PaintArrow(Graphics g, Rectangle dropDownRect)
        {
            ...
            var arrow = new[] { new Point(middle.X - 4, middle.Y - 1), new Point(middle.X + 1, middle.Y - 1), new Point(middle.X-2, middle.Y + 2) };
        ...
        private static Rectangle OverlayObjectRect(ref Rectangle container, ref Size sizeOfObject, System.Drawing.ContentAlignment alignment)
        {
            ...
            switch (alignment)
            {
                ...
                case System.Drawing.ContentAlignment.MiddleCenter:
                    x = (container.Width - sizeOfObject.Width) / 2 + BorderSize;
                    y = (container.Height - sizeOfObject.Height) / 2;
                    break;
