...
namespace Xps2Img.CommandLine
{
    ...
    #endif
    {
        ...
        #else
        [Option(PrelimsPrefixDescription, PrelimsPrefixShortOption, DefaultValue = PrelimsPrefixDefaultValue, ValidationExpression = OptionsValidators.FileNameValidationRegex)]
        #endif
